...
import { Loader2, Lock, Mail, User, Github, Globe } from "lucide-react";
...
export function HomeSignupDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="secondary" className="rounded-full px-8 py-3 text-base">
          Sign up
        </Button>
      </DialogTrigger>
      ...
      <DialogContent className="max-w-lg p-6 sm:p-8">
        <DialogHeader className="text-center sm:text-left">
          ...
          <DialogTitle className="text-2xl sm:text-3xl">Create account</DialogTitle>
          <DialogDescription className="mt-2 text-sm text-muted-foreground">
            Join now to save your workspace and access AI-assisted features.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <Label htmlFor="home-signup-name" className="text-sm font-medium text-foreground">
              Full Name
            </Label>
